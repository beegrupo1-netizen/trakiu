...
if (footerDownloadBtn) {
    footerDownloadBtn.addEventListener('click', (e) => {
        e.preventDefault();
        downloadModal.classList.add('show');
    });
}
...
// Toggle chatbot (lock body scroll on mobile when fullscreen)
function toggleChatbotScroll(active) {
...
if (chatbotToggle) {
    chatbotToggle.addEventListener('click', () => {
        ...
        toggleChatbotScroll(chatbot.classList.contains('active'));
    });
}
